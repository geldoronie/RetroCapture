...
public:
    ...
    void renderTexture(GLuint texture, uint32_t windowWidth, uint32_t windowHeight, bool flipY = true, bool enableBlend = false, float brightness = 1.0f, float contrast = 1.0f);
